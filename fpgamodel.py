...
#fpga_rev = "Rev14p1"
#fpga_file_path = "Data_compare/FPGA_Results/"+fpga_rev+'/FPGA-'+fpga_rev+'_'+freq+'_FFT_hex.txt'

#f_ar, f_ai = read_FPGA_input_lines(fpga_file_path, 32, line_n=3, x=1, y=2)
...
rebin_pwr_01_r= rebin_likefpga(xspec_pwr_r, channel_num=0, show_plots=False, save_output=None)
rebin_pwr_01_i= rebin_likefpga(xspec_pwr_i, channel_num=0, show_plots=False, save_output=None)
...
acc_pwr01_r = acc_likefpga(rebin_pwr_01_r, n_acc, channel_num=0, show_plots=False, save_output=None)
acc_pwr01_i = acc_likefpga(rebin_pwr_01_i, n_acc, channel_num=0, show_plots=False, save_output=None)
